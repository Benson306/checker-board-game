                ...
                { row.map(
                        (col, colIndex) => {
                                if(col === 'R'){
                                    ...
                                    return <div onClick={() => handleClick(rowIndex, colIndex)} style={{backgroundColor:'gray', padding:'10px', border:'1px solid black', borderWidth:1, width:40, height:40}}>{col}</div>
                                }
                        }
                        )
                } 
